...
To create and publish the image to nanobox/memcached simply run      
...
you can `vagrant ssh` and run `docker tag nanobox/memcached ${YOUR_USER}/memcached`      
then push with `docker push ${YOUR_USER}/memcached`   
